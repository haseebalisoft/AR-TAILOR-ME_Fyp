...
class FormalMenTShirtScreen extends StatefulWidget {
  const FormalMenTShirtScreen({Key? key}) : super(key: key);

  @override
  State<FormalMenTShirtScreen> createState() => _FormalMenTShirtScreenState();
}

class _FormalMenTShirtScreenState extends State<FormalMenTShirtScreen> {
  ...
  String getImagePath() {
    ...
    return "assets/images/Formal_Shirts/$combinedOptions.png";
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'Formal Men T-Shirt Customization',
